...
def main():
    ...
    plain_text_cbc = []
    plain_text_ofb = 0
    plain_text = list(map(int,input("Hello! Enter 5 numbers not exceeding 64 bits: ").split()))
